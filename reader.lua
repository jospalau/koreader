...
if G_reader_settings:isTrue("apply_extra_patches") then
    ...
    -- local ok, err = pcall(dofile, "plugins/pagetextinfo.koplugin/book_info_popup.lua") -- In Reading insights plugin
...
-- This function invokes _G.all_files to start the loop which goes over all the files:
