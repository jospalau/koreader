...
function CalendarDayView:getTitle()
    ...
    return string.format("%s (%s)", day, datetime.shortDayOfWeekToLongTranslation[HeatmapView.weekdays[date.wday]])
...
function HeatmapView:ShowHeatmapView(reader_statistics)
