...
StatusLine.DEFAULTS = {
    template  = "\xef\x82\xa0 %time_24h %books_finished2/%books_total  TR %books_tbr RM %books_read_this_month %spacer [if:batt]  %batt_icon%batt[/if][if:light]  %light_icon%light_pct[/if]  %wifi_icon",
    font_face = nil,
    font_size = 14,
    bold      = true,
    uppercase = false,
