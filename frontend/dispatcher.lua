...
local settingsList = {
    ...
    series = {category="none", event="ShowSeriesList", title=_("Series"), general=true},
    ...
    synchronize_code_phone = {category="none", event="SynchronizeCodePhone", title=_("Synchronize code phone"), general=true, separator=true},
    ...
    file_search_all = {category="none", event="ShowFileSearchLists", title=_("File search all"), filemanager=true, separator=true},
    file_search_all_recent = {category="none", event="ShowFileSearchLists", arg={recent = true}, title=_("File search all recent"), filemanager=true, separator=true},
    ...
    increase_weight = {category="none", event="IncreaseWeightSize", title=_("Increase weight size"), rolling=true},
    decrease_weight = {category="none", event="DecreaseWeightSize", title=_("Decrease weight size"), rolling=true},
                    ...
                    -- UIManager:nextTick(function() This and other nextTick() calls have been recently removed
                        ...
                        if keep_open_on_apply and not util.stringStartsWith(v.key, "touch_input")  then
                            ...
                            for prof, buttonqm in ipairs(quickmenu.buttons) do
                                if buttonqm[1] and string.match(buttonqm[1].text, " ✔") then
